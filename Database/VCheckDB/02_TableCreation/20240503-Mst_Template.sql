...
("Analyzer Software/Firmware Update Reminder","SF01","Reminder for Software Update","Kindly remember to update your analyzer's software/firmware for optimal performance. Visit https://www.bionote.com/software-updates to verify available updates.", now(), "Admin"),
