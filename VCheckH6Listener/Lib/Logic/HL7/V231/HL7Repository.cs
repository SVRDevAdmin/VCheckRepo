...
using VCheckH6Listener.Lib.PMS;

namespace VCheckH6Listener.Lib.Logic.HL7.V231
{
    public class HL7Repository
    {
        static Lib.Util.Logger _logger = new Lib.Util.Logger();
        ...
        public static async Task<bool> ProcessMessageAsync(NHapi.Base.Model.IMessage sIMessage, String sSystemName)
        {
            ...
            try
            {
                ...
                sTestResultObj.DeviceSerialNo = Worker.DeviceSerialNum != null ? Worker.DeviceSerialNum : sSerialNo.Trim();
